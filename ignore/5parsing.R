...
write.csv(gisaid, "/home/lucyhui/parsed-gisaid.csv", row.names = FALSE)
write.csv(nextstrain, "/home/lucyhui/parsed-nextstrain.csv", row.names = FALSE)

nextstrain$percent <- nextstrain$count / nextstrain$total
gisaid$percent <- gisaid$count / gisaid$total

write.csv(gisaid, "/home/lucyhui/parsed-gisaid.csv", row.names = FALSE)
write.csv(nextstrain, "/home/lucyhui/parsed-nextstrain2.csv", row.names = FALSE)
...
write.csv(gisaid, "/home/lucyhui/parsed-gisaid2.csv", row.names = FALSE)
...
write.csv(gisaid, "/home/lucyhui/parsed-gisaid3.csv", row.names = FALSE)
...
write.csv(nextstrain, "/home/lucyhui/parsed-nextstrain3.csv", row.names = FALSE)
