nextstrain <- read.csv("parsed-nextstrain3.csv")
gisaid <- read.csv("parsed-gisaid3.csv")
...
nextstrain<-subset(nextstrain, coldate > "2020-08-31")
gisaid<-subset(gisaid, coldate > "2020-08-31")

#censoring by submission dates
...
# https://www.statology.org/r-group-by-week/
...
alpha<-n102020[n102020$variant=="Alpha",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=alpha)
summary(fit)

alpha<-n112020[n112020$variant=="Alpha",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=alpha)
summary(fit)

alpha<-n122020[n122020$variant=="Alpha",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=alpha)
summary(fit)

alpha<-n012021[n012021$variant=="Alpha",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=alpha)
summary(fit)
...
beta<-n102020[n102020$variant=="Beta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=beta)
summary(fit)

beta<-n112020[n112020$variant=="Beta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=beta)
summary(fit)

beta<-n122020[n122020$variant=="Beta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=beta)
summary(fit)

beta<-n012021[n012021$variant=="Beta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=beta)
summary(fit)

beta<-n022021[n022021$variant=="Beta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=beta)
summary(fit)
...
gamma<-n102020[n102020$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=v)
summary(fit)

gamma<-n112020[n112020$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=gamma)
summary(fit)

gamma<-n122020[n122020$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=gamma)
summary(fit)

gamma<-n012021[n012021$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=gamma)
summary(fit)

gamma<-n022021[n022021$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=gamma)
summary(fit)
...
delta<-n102020[n102020$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n112020[n112020$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n122020[n122020$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n012021[n012021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n022021[n022021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n032021[n032021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n042021[n042021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n052021[n052021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n062021[n062021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n072021[n072021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n082021[n082021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-n092021[n092021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)
...
omicron<-n102020[n102020$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n112020[n112020$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n122020[n122020$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n012021[n012021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n022021[n022021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n032021[n032021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n042021[n042021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n052021[n052021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n062021[n062021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n072021[n072021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n082021[n082021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n092021[n092021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n102021[n102021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n112021[n112021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n122021[n122021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n012022[n012022$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-n022022[n022022$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)
...
alpha<-g102020[g102020$variant=="Alpha",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=alpha)
summary(fit)

alpha<-g112020[g112020$variant=="Alpha",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=alpha)
summary(fit)
...
beta<-g102020[g102020$variant=="Beta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=beta)
summary(fit)

beta<-g112020[g112020$variant=="Beta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=beta)
summary(fit)
...
gamma<-g102020[g102020$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=v)
summary(fit)

gamma<-g112020[g112020$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=gamma)
summary(fit)

gamma<-g122020[g122020$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=gamma)
summary(fit)

gamma<-g012021[g012021$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=gamma)
summary(fit)
...
delta<-g102020[g102020$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-g112020[g112020$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-g122020[g122020$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-g012021[g012021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-g022021[g022021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)

delta<-g032021[g032021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)
...
delta<-g052021[g052021$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)
...
omicron<-g102020[g102020$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g112020[g112020$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g122020[g122020$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g012021[g012021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g022021[g022021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g032021[g032021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g042021[g042021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g052021[g052021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g062021[g062021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g072021[g072021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g082021[g082021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g092021[g092021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g102021[g102021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)

omicron<-g112021[g112021$variant=="Omicron",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=omicron)
summary(fit)
...
g<-g062021[g062021$variant=="Delta",]
plot(g$week, g$percent)
...
g<-g122020[g122020$variant=="Alpha",]
ggplot(g,aes(x=week, y=cbind(count / total.y)))+
  geom_point(g=0.5)+
...
n<-n022021[n022021$variant=="Alpha",]
ggplot(n,aes(x=week, y=cbind(count / total.y)))+
  geom_point(n=0.5)+
  stat_smooth(method="glm", se=FALSE, method.args=list(family=binomial))
...
# 
n022021a<-n022021[n022021$week<20,]
alpha<-n022021a[n022021a$variant=="Alpha",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=alpha)
summary(fit)

n032021a<-n032021[n032021$week<22,]
beta<-n032021a[n032021a$variant=="Beta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=beta)
summary(fit)

n032021a<-n032021[n032021$week<22,]
gamma<-n032021a[n032021a$variant=="Gamma",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=gamma)
summary(fit)

n102021a<-n102021[n102021$week<23,]
delta<-n102021a[n102021a$variant=="Delta",]
fit<-glm(formula=cbind(count, total.y)~week, family="binomial", data=delta)
summary(fit)
